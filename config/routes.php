...
use Api\Constrollers\GetDayStdController;
use Api\Constrollers\GetUserController;
...
use Api\Constrollers\SavePhotoUserController;
...
$arrayRotas = [
    ...
    $routesProtected => [
        ...
        '/aluno/grade' => GetDayStdController::class,
